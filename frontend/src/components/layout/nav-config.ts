  ...
  switch (role) {
    ...
    case 'teacher':
      return [
        ...
        { label: 'Misconceptions', to: '/teacher/misconceptions', icon: Lightbulb, section: 'General' },
    ...
    case 'ministry_admin':
      return [
        ...
        { label: 'Model Governance', to: '/model-governance', icon: FlaskConical, section: 'General' },
        { label: 'Career Paths', to: '/career/paths', icon: Briefcase, section: 'General' },
