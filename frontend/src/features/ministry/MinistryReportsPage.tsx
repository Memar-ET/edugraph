...
export function MinistryReportsPage() {
  ...
  const genMutation = useMutation({
    mutationFn: () => generateReport({ reportType: 'national_heatmap', params: {} }),
    onMutate: () => setGenerating(true),
    onSuccess: () => {
      toast({ title: 'National report generation started', variant: 'success' })
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Generate and review ministry-level curriculum and performance reports.
            </p>
          </div>
          <button
          ...
          <CardContent className="p-0">
            {isLoading ? (
              ...
              <EmptyState
                ...
                description="Generate your first national report above."
              />
            ) : (
