...
export function MinistryAnnouncementsPage() {
  ...
  return (
    <AppShell
      title="National Ministry Directives & Notifications"
      description="System notifications, curriculum updates, and ministry-level event alerts."
    >
      <div className="space-y-4">
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            description="System notifications and ministry directives will appear here."
          />
        ) : (
