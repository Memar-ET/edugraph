...
import (
	...
	"github.com/edugraph-ai/edugraph/internal/jobs/service"
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.svc.Create(r.Context(), middleware.UserID(r.Context()), req)
	if err != nil {
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	...
	items, total, err := h.svc.ListMine(r.Context(), middleware.UserID(r.Context()), p)
	if err != nil {
		middleware.WriteError(w, err)
		return
	}
...
func (h *Handler) UpdateStatus(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.svc.UpdateStatus(r.Context(), chi.URLParam(r, "id"), req)
	if err != nil {
		middleware.WriteError(w, err)
		return
	}
