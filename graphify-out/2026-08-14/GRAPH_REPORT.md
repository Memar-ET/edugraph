# Graph Report - edugraph  (2026-08-11)

## Corpus Check
- 427 files · ~139,669 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2650 nodes · 4103 edges · 412 communities (302 shown, 110 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 600 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de9afd84`
...
1. `WriteError()` - 93 edges
2. `Internal()` - 88 edges
3. `WriteJSON()` - 69 edges
4. `BadRequest()` - 67 edges
...
## Communities (412 total, 110 thin omitted)

### Community 0 - "Authresponse"
Cohesion: 0.12
Nodes (20): Time, Context, Pool, Repository, Row, Time, New(), scanSchool() (+12 more)
...
Cohesion: 0.09
Nodes (25): CareerMatchRequest, CareerMatchResult, Client, TutorAskRequest, TutorAskResponse, Repository, Service, New() (+17 more)
...
Cohesion: 0.08
Nodes (25): Context, JobListItem, Repository, UUID, Context, JobListItem, Service, UUID (+17 more)
...
Cohesion: 0.10
Nodes (26): AuthResponse, Time, Context, Pool, Repository, Row, Time, New() (+18 more)
...
Cohesion: 0.09
Nodes (33): handlers, Handler, Logger, newRouter(), Context, Duration, Logger, Service (+25 more)
...
Cohesion: 0.13
Nodes (15): autoprefixer, eslint, devDependencies, autoprefixer, eslint, msw, prettier, @types/dagre (+7 more)

### Community 28 - "Src Types Api"
Cohesion: 0.02
Nodes (82): AddPrerequisiteRequest, AddPrerequisiteResponse, AnswerInput, ApproveRequest, ApproveResponse, AuthResponse, BloomBalanceReport, BulkGradeRequest (+74 more)
...
Cohesion: 0.08
Nodes (41): addTopicPrerequisite(), approveCurriculumJob(), askTutor(), bulkGradeExam(), generateCareerMatches(), generateStudyPlan(), getCareerMatches(), getClassHeatmap() (+33 more)
...
Cohesion: 0.29
Nodes (10): decode(), Handler, Request, ResponseWriter, Service, New(), ResponseWriter, WriteError() (+2 more)

### Community 43 - "Frontend: App Router"
Cohesion: 0.07
Nodes (21): careerPathsRoute, curriculumDashboardRoute, curriculumGraphRoute, curriculumVersionsRoute, examQualityRoute, examReviewRoute, examUploadRoute, gradeExamRoute (+13 more)
...
Cohesion: 0.22
Nodes (9): ag-grid-community, dependencies, ag-grid-community, @radix-ui/react-dialog, @radix-ui/react-tooltip, tailwind-merge, @radix-ui/react-dialog, @radix-ui/react-tooltip (+1 more)
...
Cohesion: 0.12
Nodes (20): Time, Context, Pool, Repository, Row, Time, New(), scanTeacher() (+12 more)

### Community 63 - "Ministry Handler"
Cohesion: 0.17
Nodes (13): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Service, New() (+5 more)
...
Cohesion: 0.17
Nodes (9): Pass 3: LLM synthesis with Gemini (Capability 3A).  One request per analyzed att, gap_contexts: [{"index", "question_text", "symptom_topic",     "root_cause_topic, synthesize_insights(), _fallback_summary(), process_gap_job(), Capability 3A: The Granular Gap Analysis Engine ("Diagnostic Doctor").  Runs whe, Deterministic English summary when Gemini is unavailable -- the     Exam Insight, Consumes gap-analysis jobs off Redis (Capability 3A).  Mirrors exam_worker.py ex (+1 more)
...
Cohesion: 0.09
Nodes (24): CurriculumDashboardPage(), formatDate(), JobTableRow, MOCK_CURRICULUM_DONUT, MOCK_CURRICULUM_PERFORMANCE, MOCK_CURRICULUM_SCHEDULE, STATUS_LABEL, STATUS_TONE (+16 more)
...
Cohesion: 0.09
Nodes (24): apply_answer_key(), _clo_align_method(), fetch_clos_for_subject(), fetch_exam(), fetch_exam_school(), fetch_valid_clo_codes(), mark_exam_failed(), mark_exam_parsing() (+16 more)

### Community 76 - "autoprefixer"
Cohesion: 0.32
Nodes (6): Context, Service, StudyPlan, UUID, GenerateStudyPlanRequest, GenerateStudyPlanResponse
...
Cohesion: 0.10
Nodes (31): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Handler, Request (+23 more)
...
Cohesion: 0.28
Nodes (6): ask_tutor(), AskRequest, POST /api/v1/tutor/ask (Capability 3C) -- called by the Go API's tutor proxy (in, lifespan(), BaseModel, FastAPI
...
Cohesion: 0.33
Nodes (6): ABC, EmbeddingProvider, get_embedding_provider(), Pluggable embedding provider for the CLO/topic embedding pipeline (app/workers/e, Return an EMBEDDING_DIM-length vector for `text`., StubEmbeddingProvider
...
### Community 376 - "Struct"
Cohesion: 0.18
Nodes (13): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, decode(), Handler (+5 more)

### Community 377 - "main"
Cohesion: 0.18
Nodes (7): main(), main(), EnsureDevKeyPair(), Pool, NewPool(), InitTracer(), TracerProvider

### Community 378 - ".PresignDownload"
Cohesion: 0.83
Nodes (3): Repository, Service, New()
...
### Community 385 - "Run"
Cohesion: 0.20
Nodes (8): brpop_job(), close_redis(), get_redis(), Redis access for the AI service.  The Go backend pushes a plain job id string on, Block for up to `timeout` seconds waiting for a job id on `queue`.     Returns N, Consumes study-plan generation jobs off Redis (Capability 3B).  Same BRPOP loop, run_forever(), Redis

### Community 389 - "service.py"
Cohesion: 0.29
Nodes (9): _aggregate_topics(), _pack_days(), _plan_summary(), process_study_plan_job(), Capability 3B: The Study Plan Generator ("Personal Tutor").  Input is the rich 3, Kahn's algorithm over prerequisite edges among the study topics.     Ready set i, Greedy day packing at HOURS_PER_DAY: small topics share a day, a     big topic s, Collapse gap records into per-topic study entries. A topic can appear     as a s (+1 more)

### Community 390 - "neo4j.py"
Cohesion: 0.31
Nodes (8): close_neo4j(), fetch_prerequisite_chain(), fetch_prerequisite_edges_among(), get_driver(), Neo4j access for the AI service (Capability 3A: root-cause traversal).  The Go s, Walk backwards up the prerequisite graph from a symptom topic:     every (:Topic, All direct HAS_PREREQUISITE edges whose BOTH endpoints are in     topic_ids -- t, AsyncDriver

### Community 391 - "service.py"
Cohesion: 0.39
Nodes (7): ask(), Capability 3C: The AI Tutor (Graph-RAG + Gemini).  When a student asks a questio, Raised when GEMINI_API_KEY is unset or the model call fails., _score_topic(), _tokenize(), TutorUnavailable, Exception
...
Cohesion: 0.29
Nodes (4): process_exam_job(), Orchestrates one exam-parsing job end to end (Capability 2A):    1. Fetch the ex, Consumes exam-upload jobs off Redis and parses them (Capability 2A).  Mirrors cu, run_forever()
...
Cohesion: 0.43
Nodes (4): Context, PresignDownloadRequest, PresignResponse, PresignUploadRequest
...
## Knowledge Gaps
- **550 isolated node(s):** `users`, `students`, `teachers`, `notifications`, `sync_logs` (+545 more)
...
- **Why does `Internal()` connect `DB Migration V013: create local storage` to `Authresponse`, `Architecture Doc: (root)`, `Notification Dto`, `Auth Repository`, `Career Repository`, `.PresignDownload`, `Sync Dto`, `.UploadAnswerKey`, `Teacher Handler`, `Cmd Api Main`, `Jobs Handler`, `Storage Dto`, `Impl Plan Doc: (root)`, `Ministry Dto`, `redis.py`, `Ministry Handler`, `Service`, `Service`, `autoprefixer`, `ag-grid-community`, `.UploadExam`, `Internal`, `.AskTutor`, `logger.go`, `Run`, `Services Tutor Service`, `Internal`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `WriteError()` connect `Teacher Handler` to `Region Handler`, `School Handler`, `Student Handler`, `dto.go`, `Career Handler`, `Jobs Handler`, `DB Migration V013: create local storage`, `Storage Handler`, `DB Design Doc: Node Labels And Properties`, `Student Repository`, `Struct`, `.UploadExam`, `Auth Handler`, `Ministry Handler`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `NotFound()` connect `Internal` to `Authresponse`, `Architecture Doc: (root)`, `Ai Careermatchrequest`, `Curriculum Dto`, `Notification Dto`, `Auth Repository`, `.UploadAnswerKey`, `Impl Plan Doc: The Fundamental Dependency Chain`, `Cmd Api Main`, `Storage Dto`, `Impl Plan Doc: (root)`, `redis.py`, `Service`, `Service`, `ag-grid-community`, `Internal`, `logger.go`, `Run`, `ag-grid-react`, `Services Tutor Service`?**
