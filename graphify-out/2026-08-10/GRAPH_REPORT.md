# Graph Report - edugraph  (2026-08-10)

## Corpus Check
- 404 files · ~118,522 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2432 nodes · 3803 edges · 378 communities (269 shown, 109 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 576 edges (avg confidence: 0.8)
...
1. `WriteError()` - 90 edges
2. `Internal()` - 85 edges
3. `Table of Contents` - 67 edges
4. `WriteJSON()` - 65 edges
...
## Communities (378 total, 109 thin omitted)
...
Cohesion: 0.09
Nodes (24): CareerMatchRequest, CareerMatchResult, Client, TutorAskRequest, TutorAskResponse, Repository, Service, New() (+16 more)
...
Cohesion: 0.10
Nodes (27): RawMessage, Time, UUID, ApproveResponse, Context, DriverWithContext, JobStatus, ParsedStructurePayload (+19 more)
...
Cohesion: 0.05
Nodes (40): main(), DriverWithContext, main(), runMigrations(), splitStatements(), main(), getEnv(), main() (+32 more)
...
Cohesion: 0.09
Nodes (23): Banner(), BannerProps, toneStyles, Button, ButtonProps, buttonVariants, Card(), CardContent() (+15 more)
...
Cohesion: 0.10
Nodes (24): Context, Repository, UUID, Context, Repository, UUID, Context, Service (+16 more)
...
Cohesion: 0.18
Nodes (18): handlers, Handler, Logger, newRouter(), Authenticate(), CORS(), Context, Handler (+10 more)
...
Cohesion: 0.03
Nodes (70): AnswerInput, ApproveRequest, ApproveResponse, AuthResponse, BloomBalanceReport, BulkGradeRequest, BulkGradeResponse, CareerMatchResponse (+62 more)
...
Cohesion: 0.10
Nodes (32): approveCurriculumJob(), askTutor(), bulkGradeExam(), generateCareerMatches(), generateStudyPlan(), getCareerMatches(), getClassHeatmap(), getCurriculumJob() (+24 more)

### Community 37 - "Impl Plan Doc: The Fundamental Dependency Chain"
Cohesion: 0.13
Nodes (18): Context, Duration, Logger, Service, Run(), Context, Duration, Logger (+10 more)
...
Cohesion: 0.08
Nodes (18): careerPathsRoute, curriculumDashboardRoute, examQualityRoute, examReviewRoute, examUploadRoute, gradeExamRoute, indexRoute, jobReviewRoute (+10 more)

### Community 44 - "Cmd Api Main"
Cohesion: 0.09
Nodes (34): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Handler, Request (+26 more)
...
Cohesion: 0.22
Nodes (9): ag-grid-react, dependencies, ag-grid-react, react-dom, tailwind-merge, @tanstack/react-query, react-dom, tailwind-merge (+1 more)
...
Cohesion: 0.20
Nodes (13): Handler, Request, ResponseWriter, Service, New(), writeServiceError(), Handler, Request (+5 more)
...
Cohesion: 0.22
Nodes (8): CurriculumDashboardPage(), formatDate(), STATUS_LABEL, STATUS_TONE, IN_PROGRESS_STATUSES, JobReviewPage(), linesToList(), UploadPage()
...
Cohesion: 0.23
Nodes (10): Time, Context, Repository, Service, New(), toResponse(), CreateRegionRequest, RegionResponse (+2 more)
...
Cohesion: 0.17
Nodes (10): Time, Context, Repository, Tx, Context, Service, NotFound(), SubjectVersion (+2 more)
...
Cohesion: 0.20
Nodes (9): Architecture, Critical Decisions, Database Structure, Development Rules, Important Files, Key Components — The Curriculum Pipeline (Phase 1), Known Gaps / Incomplete Work, What's Built — CLO/Topic Embeddings, Officer Dashboard, Curriculum Versioning (2026-08-10) (+1 more)
...
Cohesion: 0.50
Nodes (3): MinistryDashboardPage(), getMinistryOverview(), listRegions()

### Community 284 - "School Admin Index"
Cohesion: 0.33
Nodes (3): NotifySection(), SchoolAdminDashboardPage(), createNotification()

### Community 285 - "Features Student Index"
Cohesion: 0.17
Nodes (10): CareerMatchesSection(), StudentDashboardPage(), StudyPlanSection(), SubjectHealthSection(), ChatTurn, MARKDOWN_COMPONENTS, TutorPage(), useMyStudentRecord() (+2 more)
...
## Knowledge Gaps
- **455 isolated node(s):** `users`, `students`, `teachers`, `notifications`, `sync_logs` (+450 more)
...
- **Why does `Internal()` connect `Cmd Api Main` to `Authresponse`, `Architecture Doc: (root)`, `Notification Dto`, `Api Handlers`, `Auth Repository`, `Career Repository`, `Pkg Crypto Crypto`, `Sync Dto`, `Jobs Handler`, `Storage Dto`, `Ministry Dto`, `redis.py`, `Ministry Handler`, `Service`, `Service`, `autoprefixer`, `ag-grid-community`, `Repository`, `.UploadExam`, `.AskTutor`, `logger.go`, `Run`, `Services Tutor Service`, `.UploadAnswerKey`, `Internal`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `WriteError()` connect `Ministry Handler` to `Region Handler`, `School Handler`, `Student Handler`, `dto.go`, `Teacher Handler`, `Cmd Api Main`, `Career Handler`, `Jobs Handler`, `Notification Handler`, `Storage Handler`, `DB Design Doc: Node Labels And Properties`, `Student Repository`, `.UploadExam`, `Auth Handler`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `newRouter()` connect `Student Repository` to `Api Handlers`, `Auth Handler`?**
