...
## Corpus Check
- 426 files · ~136,853 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2640 nodes · 4092 edges · 409 communities (299 shown, 110 thin omitted)
...
## Communities (409 total, 110 thin omitted)
...
Cohesion: 0.08
Nodes (31): CareerMatchRequest, CareerMatchResult, Client, TutorAskRequest, TutorAskResponse, Repository, Service, New() (+23 more)
...
Cohesion: 0.10
Nodes (23): Context, Repository, UUID, Context, Repository, UUID, Context, Service (+15 more)
...
Cohesion: 0.13
Nodes (15): eslint, devDependencies, eslint, msw, postcss, prettier, @types/dagre, vite (+7 more)
...
Cohesion: 0.07
Nodes (36): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Context, Reader (+28 more)
...
Cohesion: 0.14
Nodes (17): Handler, Request, ResponseWriter, decode(), Handler, Request, ResponseWriter, Service (+9 more)
...
Cohesion: 0.13
Nodes (19): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Service, New() (+11 more)
...
Cohesion: 0.12
Nodes (20): Time, Context, DriverWithContext, Pool, Repository, Row, Time, New() (+12 more)
...
Cohesion: 0.40
Nodes (4): Context, JobListItem, Repository, UUID
...
Cohesion: 0.40
Nodes (4): Context, JobListItem, Service, UUID
...
Cohesion: 0.12
Nodes (20): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Handler, Request (+12 more)

### Community 147 - "Claude"
Cohesion: 0.18
Nodes (10): Architecture, Critical Decisions, Database Structure, Development Rules, Important Files, Key Components — The Curriculum Pipeline (Phase 1), Known Gaps / Incomplete Work, Postgres is now Supabase (2026-08-10) (+2 more)
...
Cohesion: 0.40
Nodes (4): Time, CreateRegionRequest, RegionResponse, UpdateRegionRequest
...
Cohesion: 0.50
Nodes (3): Time, CareerPathResponse, CreateCareerPathRequest
...
Cohesion: 0.16
Nodes (14): Handler, Request, ResponseWriter, decode(), Handler, Request, ResponseWriter, Service (+6 more)
...
Cohesion: 0.36
Nodes (7): fetch_prerequisite_chain(), fetch_prerequisite_edges_among(), get_driver(), Neo4j access for the AI service (Capability 3A: root-cause traversal).  The Go s, Walk backwards up the prerequisite graph from a symptom topic:     every (:Topic, All direct HAS_PREREQUISITE edges whose BOTH endpoints are in     topic_ids -- t, AsyncDriver

### Community 391 - "service.py"
Cohesion: 0.23
Nodes (11): ask_tutor(), AskRequest, POST /api/v1/tutor/ask (Capability 3C) -- called by the Go API's tutor proxy (in, ask(), Capability 3C: The AI Tutor (Graph-RAG + Gemini).  When a student asks a questio, Raised when GEMINI_API_KEY is unset or the model call fails., _score_topic(), _tokenize() (+3 more)
...
## Knowledge Gaps
- **549 isolated node(s):** `users`, `students`, `teachers`, `notifications`, `sync_logs` (+544 more)
...
- **Why does `Internal()` connect `Cmd Api Main` to `Authresponse`, `Architecture Doc: (root)`, `Ai Careermatchrequest`, `Notification Dto`, `DB Migration V013: create local storage`, `Auth Repository`, `Pkg Crypto Crypto`, `Sync Dto`, `Jobs Handler`, `Storage Dto`, `Impl Plan Doc: (root)`, `Ministry Dto`, `redis.py`, `Ministry Handler`, `Service`, `autoprefixer`, `ag-grid-community`, `.UploadExam`, `.AskTutor`, `logger.go`, `Run`, `Services Tutor Service`, `Struct`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `WriteError()` connect `Ministry Handler` to `Region Handler`, `School Handler`, `Student Handler`, `dto.go`, `Teacher Handler`, `Cmd Api Main`, `Career Handler`, `Jobs Handler`, `DB Migration V013: create local storage`, `Storage Handler`, `Student Repository`, `Struct`, `.UploadExam`, `Auth Handler`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `newRouter()` connect `Student Repository` to `main`, `Api Handlers`, `DB Migration V013: create local storage`?**
