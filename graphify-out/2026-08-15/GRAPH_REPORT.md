# Graph Report - edugraph  (2026-08-14)

## Corpus Check
- 477 files · ~183,900 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3078 nodes · 4881 edges · 426 communities (312 shown, 114 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 746 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e4641164`
...
- Features Career Index
- Features Ministry Index
- Features Regional Index
- School Admin Index
- Features Student Index
- Features Teacher Index
- Lib Utils Date
...
- @vitest/coverage-v8
- run-load-test.sh
- github.com/edugraph-ai/edugraph-sync-agent

## God Nodes (most connected - your core abstractions)
1. `Internal()` - 107 edges
2. `WriteError()` - 97 edges
3. `BadRequest()` - 71 edges
4. `WriteJSON()` - 71 edges
5. `Table of Contents` - 67 edges
6. `get_pool()` - 46 edges
7. `unwrap()` - 46 edges
8. `NotFound()` - 44 edges
9. `UserID()` - 33 edges
...
## Communities (426 total, 114 thin omitted)

### Community 0 - "Authresponse"
Cohesion: 0.22
Nodes (11): Time, Context, Repository, Service, New(), nilIfEmpty(), toResponse(), CreateSchoolRequest (+3 more)
...
Cohesion: 0.07
Nodes (34): CareerMatchRequest, CareerMatchResult, Client, TutorAskRequest, TutorAskResponse, Pool, Service, T (+26 more)
...
Cohesion: 0.11
Nodes (31): RawMessage, Time, UUID, ApproveResponse, Context, DriverWithContext, JobStatus, ParsedStructurePayload (+23 more)

### Community 6 - "Parser Docx Extractor"
Cohesion: 0.09
Nodes (50): _build_units_topics_clos(), _extract_legacy(), extract_structure(), _group_clos_into_topics(), _heading_level(), _iter_block_items(), DOCX counterpart to extractor.py.  Tries the same "Unified ID Convention" plain-, Dict-based equivalent of extractor.py's _group_clos_into_topics --     groups CL (+42 more)
...
Cohesion: 0.09
Nodes (20): DistributionBars(), DistributionBarsProps, TONE_BAR, HeatmapGrid(), HeatmapGridProps, intensityTone(), ScoreGauge(), ScoreGaugeProps (+12 more)
...
Cohesion: 0.15
Nodes (15): Context, Pool, Repository, Row, Time, New(), scan(), Context (+7 more)
...
Cohesion: 0.12
Nodes (26): T, TestMatches_ScopedToCallerOwnStudentRecord(), T, TestApproveAndPromote_WritesAttribution(), Pool, Service, T, newTestStudentService() (+18 more)

### Community 13 - "Frontend: UI Kit Components"
Cohesion: 0.09
Nodes (25): Banner(), BannerProps, toneStyles, Button, ButtonProps, buttonVariants, Card(), CardContent() (+17 more)
...
Cohesion: 0.07
Nodes (43): Time, AuthResponse, Context, Duration, Repository, Service, hashToken(), New() (+35 more)

### Community 17 - "Career Repository"
Cohesion: 0.10
Nodes (22): Time, Context, DriverWithContext, Pool, Repository, Row, Time, New() (+14 more)

### Community 18 - "Notification Handler"
Cohesion: 0.04
Nodes (45): 1.1 Overview, 1.2 Design Aesthetics & Visual Tokens, 1. Curriculum Officer Dashboard (`/curriculum`), 1. Executive Summary & Design System Architecture, 1. School Admin Dashboard (`/` for Role `school_admin`), 1. Student Command Center (`/` for Role `student`), 1. Teacher Dashboard (`/` for Role `teacher`), 2.1 Core Stack Dependencies (+37 more)

### Community 19 - "Pkg Crypto Crypto"
Cohesion: 0.07
Nodes (33): Context, Repository, UUID, Context, QuestionOption, Repository, UUID, Context (+25 more)
...
Cohesion: 0.13
Nodes (25): handlers, Config, Handler, Logger, newRouter(), authCookie(), Authenticate(), ClearAuthCookies() (+17 more)
...
Cohesion: 0.13
Nodes (15): eslint, eslint-plugin-react-hooks, devDependencies, eslint, eslint-plugin-react-hooks, msw, postcss, @testing-library/react (+7 more)

### Community 28 - "Src Types Api"
Cohesion: 0.02
Nodes (85): AddPrerequisiteRequest, AddPrerequisiteResponse, AnswerInput, ApproveRequest, ApproveResponse, AuthResponse, BloomBalanceReport, BulkGradeRequest (+77 more)
...
Cohesion: 0.34
Nodes (7): decode(), AuthResponse, Handler, Request, ResponseWriter, Service, New()
...
Cohesion: 0.31
Nodes (7): Context, ExamInsight, ExamInsightListEntry, Repository, SubjectProfile, UUID, GapRecordEntry
...
Cohesion: 0.36
Nodes (7): Time, CLOFlag, CLOCoverageQuality, CLOFlag, ExamQualityResponse, QuestionQuality, TimeAnalysisQuality

### Community 36 - "Frontend: API Client"
Cohesion: 0.07
Nodes (43): addTopicPrerequisite(), approveCurriculumJob(), askTutor(), bulkGradeExam(), generateCareerMatches(), generateStudyPlan(), getCareerMatches(), getClassHeatmap() (+35 more)

### Community 37 - "Impl Plan Doc: The Fundamental Dependency Chain"
Cohesion: 0.28
Nodes (7): asIntPtr(), Context, Record, Repository, SessionWithContext, SubjectGraph, runAndCollect()
...
Cohesion: 0.20
Nodes (12): Handler, Request, ResponseWriter, decode(), Handler, Request, ResponseWriter, Service (+4 more)

### Community 40 - "Student Handler"
Cohesion: 0.18
Nodes (14): decode(), Handler, Request, ResponseWriter, Service, New(), decode(), Handler (+6 more)

### Community 41 - "Sync Repository"
Cohesion: 0.30
Nodes (9): Context, Pool, Repository, Time, New(), scanLog(), CreateLogParams, DeviceCredential (+1 more)
...
Cohesion: 0.07
Nodes (23): careerPathsRoute, curriculumDashboardRoute, curriculumGraphRoute, curriculumVersionsRoute, examQualityRoute, examReviewRoute, examUploadRoute, gradeExamRoute (+15 more)

### Community 44 - "Cmd Api Main"
Cohesion: 0.33
Nodes (6): Context, ExamInsight, ExamInsightListEntry, Service, SubjectProfile, UUID
...
Cohesion: 0.09
Nodes (30): Context, Repository, UpdateExamScopeRequest, UUID, Context, Repository, UUID, computeBloomBalance() (+22 more)

### Community 48 - "Impl Plan Doc: (root)"
Cohesion: 0.33
Nodes (7): AddPrerequisiteRequest, AddPrerequisiteResponse, Context, PrerequisiteLink, Service, UUID, ResyncPrerequisitesResponse
...
Cohesion: 0.24
Nodes (7): Context, Repository, Service, New(), OverviewResponse, RegionStatsResponse, RegionStatsResponse
...
Cohesion: 0.20
Nodes (11): DeviceAuth(), deviceSchoolID(), Context, Handler, Handler, Request, ResponseWriter, Service (+3 more)

### Community 55 - "Frontend: NPM Dependencies"
Cohesion: 0.22
Nodes (9): class-variance-authority, dependencies, class-variance-authority, @radix-ui/react-dialog, @radix-ui/react-tooltip, tailwind-merge, @radix-ui/react-dialog, @radix-ui/react-tooltip (+1 more)
...
Cohesion: 0.20
Nodes (12): Time, Context, Repository, Service, New(), nilIfEmpty(), scopeErr(), toResponse() (+4 more)

### Community 63 - "Ministry Handler"
Cohesion: 0.10
Nodes (23): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Service, New() (+15 more)
...
Cohesion: 0.25
Nodes (6): _fallback_summary(), process_gap_job(), Capability 3A: The Granular Gap Analysis Engine ("Diagnostic Doctor").  Runs w, Deterministic English summary when Gemini is unavailable -- the     Exam Insigh, Consumes gap-analysis jobs off Redis (Capability 3A).  Mirrors exam_worker.py ex, run_forever()

### Community 66 - "Service"
Cohesion: 0.21
Nodes (12): Time, Context, Repository, Service, New(), scopeErr(), toResponse(), NotFound() (+4 more)
...
Cohesion: 0.07
Nodes (31): CurriculumDashboardPage(), formatDate(), JobTableRow, MOCK_CURRICULUM_DONUT, MOCK_CURRICULUM_PERFORMANCE, MOCK_CURRICULUM_SCHEDULE, STATUS_LABEL, STATUS_TONE (+23 more)
...
Cohesion: 0.13
Nodes (18): Time, Context, Pool, Repository, Row, Time, New(), scanRegion() (+10 more)

### Community 75 - "curriculum handler.Upload — fixed wrong context key + double body-read bugs"
Cohesion: 0.07
Nodes (30): apply_answer_key(), _clo_align_method(), fetch_clos_for_subject(), fetch_exam(), fetch_exam_for_rematch(), fetch_exam_school(), fetch_questions_for_rematch(), fetch_valid_clo_codes() (+22 more)

### Community 76 - "autoprefixer"
Cohesion: 0.20
Nodes (12): Context, Service, StudyPlan, UUID, Conflict(), Forbidden(), New(), NotImplemented() (+4 more)
...
Cohesion: 0.40
Nodes (3): asyncpg connection string built from the individual settings above.         Use, Settings, BaseSettings
...
Cohesion: 0.30
Nodes (7): Context, PrerequisiteLink, Repository, Tx, UUID, topicCore, UnsyncedPrerequisite
...
### Community 96 - "Job"
Cohesion: 0.09
Nodes (11): DistributionDonutChartProps, DonutSegment, ManagementTableCardProps, TableColumn, ChartDataPoint, PerformanceAreaChartProps, WEEKLY_DATA, DEFAULT_DAYS (+3 more)
...
Cohesion: 0.14
Nodes (19): Context, Repository, UUID, applyTimeAnomalies(), bucketDifficulty(), cloCoverage(), discriminationIndex(), examQualityScore() (+11 more)
...
### Community 101 - "Run"
Cohesion: 0.15
Nodes (13): Context, Repository, Time, UUID, Context, Service, UUID, pct() (+5 more)

### Community 102 - "dto.go"
Cohesion: 0.50
Nodes (3): Time, UUID, JobListItem

### Community 103 - "ag-grid-react"
Cohesion: 0.33
Nodes (5): Context, Repository, SubjectVersion, Tx, subjectVersionCore

### Community 104 - "dto.go"
Cohesion: 0.43
Nodes (7): RawMessage, Time, UUID, ExamInsight, ExamInsightListEntry, GapRecordEntry, SubjectProfile

### Community 114 - "Components Layout Appheader"
Cohesion: 0.36
Nodes (7): AppHeader(), AppShell(), AppShellProps, getNavItems(), NavItem, ROLE_LABELS, NotificationBell()

### Community 122 - ".UploadAnswerKey"
Cohesion: 0.50
Nodes (4): AddPrerequisiteRequest, AddPrerequisiteResponse, PrerequisiteLink, ResyncPrerequisitesResponse

### Community 123 - "clo_matcher_llm.py"
Cohesion: 0.19
Nodes (6): _FakeProvider, MonkeyPatch, Tests for app/services/gap_analysis/llm.py -- Capability 3A's Pass 3 LLM synthe, test_synthesize_insights_returns_none_triple_when_all_providers_fail(), test_synthesize_insights_returns_parsed_result_on_success(), test_synthesize_insights_survives_malformed_llm_response()

### Community 125 - "eslint-plugin-react-hooks"
Cohesion: 0.60
Nodes (4): HeatmapAlert, ClassHeatmapResponse, HeatmapAlert, HeatmapTopic
...
Cohesion: 0.18
Nodes (12): Context, Duration, Logger, Service, Run(), Any(), Error(), Logger (+4 more)
...
Cohesion: 0.14
Nodes (10): Context, JobListItem, Repository, UUID, Context, JobListItem, Service, UUID (+2 more)

### Community 130 - "persist_analysis"
Cohesion: 0.29
Nodes (6): RawMessage, Time, UUID, GenerateStudyPlanRequest, GenerateStudyPlanResponse, StudyPlan
...
Cohesion: 0.14
Nodes (14): fetch_gaps_for_plan(), fetch_prereq_edges_pg(), fetch_student_school(), fetch_target_exam_due_date(), fetch_topic_meta(), insert_study_plan(), Record, Postgres access layer for the study-plan generator (Capability 3B).  Reads the (+6 more)
...
### Community 142 - "DB Migration V013: create local storage"
Cohesion: 0.06
Nodes (47): Handler, Request, ResponseWriter, Handler, Request, ResponseWriter, Handler, Request (+39 more)

### Community 146 - "Frontend: NPM Dependencies"
Cohesion: 0.24
Nodes (9): find_best_matching_clo(), has_embeddings_for_subject(), Record, Postgres access for embeddings.clo_embeddings / embeddings.question_embeddings, Cheap existence check the matcher uses to decide whether it's even     worth do, Nearest CLO (by cosine similarity) within `subject_code` to the given     embed, Stores a question's embedding for audit/debugging and so a future     re-matchi, upsert_question_embedding() (+1 more)

### Community 147 - "Claude"
Cohesion: 0.15
Nodes (12): Architecture, Critical Decisions, Database Structure, Development Rules, Important Files, Key Components — The Curriculum Pipeline (Phase 1), Known Gaps / Incomplete Work, New finding: `ApproveAndPromote` is slow over Supabase for a full grade, and the Vite dev proxy hides it as a false 500 (+4 more)

### Community 148 - "Frontend: NPM Dependencies"
Cohesion: 0.40
Nodes (4): Context, Repository, StudyPlan, UUID

### Community 150 - "Frontend: NPM Dependencies"
Cohesion: 0.25
Nodes (5): main(), DriverWithContext, NewDriver(), InitTracer(), TracerProvider
...
### Community 158 - "Frontend: NPM Dependencies"
Cohesion: 0.67
Nodes (3): getEnv(), main(), DemoUser

### Community 163 - "Frontend: NPM Dependencies"
Cohesion: 0.32
Nodes (6): _clo(), extract_grade(), Shared strategy for documents following the "Unified ID Convention" curriculum f, Splits the whole document into logical lines on marker boundaries     (not on ra, Extracts one grade's units/topics/subtopics/CLOs, ignoring every     other grade, _tokenize()

### Community 172 - "Frontend: NPM Dependencies"
Cohesion: 0.83
Nodes (3): GraphEdge, GraphNode, SubjectGraph

### Community 174 - "Frontend: NPM Dependencies"
Cohesion: 0.50
Nodes (3): Context, Service, SubjectGraph

### Community 176 - "Frontend: NPM Dependencies"
Cohesion: 0.25
Nodes (7): AI Tutor (Capability 3C), Correcting the record: this *is* in the PRD, Offline capability (checklist 5.2), Scope status: official, in-scope feature (confirmed), Verification, What's built: chat Q&A, What's missing: practice-problem generation

### Community 180 - "Frontend: NPM Dependencies"
Cohesion: 0.43
Nodes (5): Context, Service, UpdateExamScopeRequest, UUID, UpdateExamScopeResponse

### Community 182 - "Frontend: NPM Dependencies"
Cohesion: 0.48
Nodes (6): Context, Duration, Logger, Repository, Run(), syncOnce()

### Community 195 - "Shell Script: Health Check"
Cohesion: 0.70
Nodes (4): fail(), ok(), send_alert(), health-check.sh script

### Community 210 - "V1 Routes Career"
Cohesion: 0.47
Nodes (5): career_match(), CareerMatchRequest, CareerMatchResult, BaseModel, POST /api/v1/career/match (Capability 3D) -- called by the Go API's career serv

### Community 216 - "V1 Routes Tutor"
Cohesion: 0.40
Nodes (4): close_neo4j(), close_pool(), lifespan(), FastAPI

### Community 220 - "App Db Pgvector"
Cohesion: 0.21
Nodes (11): fetch_clo_text(), fetch_topic_text(), Read/write helpers for the embeddings.* schema (CLO/topic embeddings).  Kept sep, Text to embed for a curriculum.topics row, or None if it doesn't exist., Text to embed for a curriculum.clos row, or None if it doesn't exist., _to_vector_literal(), upsert_clo_embedding(), upsert_topic_embedding() (+3 more)

### Community 229 - "Career Matcher Service"
Cohesion: 0.25
Nodes (7): fetch_career_paths(), Postgres access for career matching (Capability 3D).  Reads career_paths_v010,, required_subjects comes back JSONB-as-text from asyncpg (no JSON     codec regi, match_careers(), _normalize(), Capability 3D: Career Recommendation Engine.  The PRD's design is Neo4j-native, grades: {subject_family: avg_percentage_0_to_100}, already computed     and nor

### Community 240 - "Services Tutor Service"
Cohesion: 0.20
Nodes (10): Context, Repository, UUID, Context, HeatmapAlert, Service, UUID, ClassHeatmapResponse (+2 more)

### Community 241 - "App Utils Embeddings"
Cohesion: 0.33
Nodes (6): EmbeddingProvider, get_embedding_provider(), ABC, Pluggable embedding provider for the CLO/topic embedding pipeline (app/workers/e, Return an EMBEDDING_DIM-length vector for `text`., StubEmbeddingProvider

### Community 267 - "Architecture Offline Sync"
Cohesion: 0.05
Nodes (34): 8.1 — Decision: build local-first by default, 8.2 — Local embedding generator, 8.3 — Local LLM (Ollama) fallback for gap analysis, study plans, and the tutor, AI Models: Local vs. Cloud (checklist 8.1/8.2/8.3), Amharic, Verification, 10.1 — Multi-tenancy audit, 10.2 — Curriculum versioning schema (+26 more)

### Community 268 - "Docs Architecture Security"
Cohesion: 0.29
Nodes (6): Career Guidance (Capability 3D), Not done, left as documented future work, Scope status: official, in-scope feature (confirmed), Verification, What was actually broken (checklist 7.1), What was fixed

### Community 270 - "Gap Analysis Job"
Cohesion: 0.29
Nodes (6): Cold-start handling ("never tested" prerequisites), Debugging a gap-analysis run, Gap Analysis Job (Capability 3A), How this was verified, Prerequisite data: mechanism vs. population, What actually runs today (superseding the PRD's description)

### Community 276 - "Frontend Playwright Config"
Cohesion: 0.50
Nodes (3): process_rematch_job(), Capability 2D: consumes queue:exam:rematch and re-runs CLO matching for an exam, run_forever()

### Community 281 - "Features Career Index"
Cohesion: 0.40
Nodes (3): CareerPathsPage(), createCareerPath(), listCareerPaths()

### Community 282 - "Features Ministry Index"
Cohesion: 0.25
Nodes (7): MinistryDashboardPage(), MOCK_MINISTRY_DONUT, MOCK_MINISTRY_PERFORMANCE, MOCK_MINISTRY_SCHEDULE, RegionRowItem, getMinistryOverview(), listRegions()

### Community 283 - "Features Regional Index"
Cohesion: 0.25
Nodes (4): MOCK_REGIONAL_DONUT, MOCK_REGIONAL_PERFORMANCE, MOCK_REGIONAL_SCHEDULE, RegionalDashboardPage()

### Community 284 - "School Admin Index"
Cohesion: 0.22
Nodes (6): MOCK_SCHOOL_DONUT, MOCK_SCHOOL_PERFORMANCE, MOCK_SCHOOL_SCHEDULE, NotifySection(), SchoolAdminDashboardPage(), createNotification()

### Community 285 - "Features Student Index"
Cohesion: 0.20
Nodes (9): ExamRowItem, MOCK_DONUT_SEGMENTS, MOCK_PERFORMANCE_DATA, MOCK_SCHEDULE_ITEMS, StudentDashboardPage(), ChatTurn, MARKDOWN_COMPONENTS, TutorPage() (+1 more)

### Community 286 - "Features Teacher Index"
Cohesion: 0.29
Nodes (6): MOCK_EXAM_ROWS, MOCK_TEACHER_DONUT, MOCK_TEACHER_PERFORMANCE, MOCK_TEACHER_SCHEDULE, TeacherDashboardPage(), TeacherExamRow

### Community 288 - "Lib Utils Date"
Cohesion: 0.70
Nodes (4): formatDate(), formatDateTime(), formatRelative(), toDate()
...
### Community 297 - "E2e Auth Spec"
Cohesion: 0.31
Nodes (4): DEMO_USERS, SeededExam, seeded, seeded

### Community 298 - "Student Flow Spec"
Cohesion: 0.50
Nodes (3): match_clo_vector(), Semantic (vector-embedding-based) CLO matcher -- Capability 2.1 / PRD Section 5, Returns (clo_code, score, classification) where classification is one     of "a

### Community 299 - "Teacher Flow Spec"
Cohesion: 0.50
Nodes (3): UUID, UpdateExamScopeRequest, UpdateExamScopeResponse

### Community 348 - "School Box Readme"
Cohesion: 0.50
Nodes (3): Context, Repository, SubjectListItem

### Community 349 - "Agent Cmd Main"
Cohesion: 0.05
Nodes (48): configError, State, syncStatus, RWMutex, envOr(), errRequired(), Config, loadConfig() (+40 more)

### Community 350 - "Internal Health Health"
Cohesion: 0.50
Nodes (3): Context, Service, SubjectListItem

### Community 351 - "Internal Sync Agent"
Cohesion: 0.50
Nodes (3): OFFSET, options, VUS

### Community 355 - ".AskTutor"
Cohesion: 0.33
Nodes (5): Context, Service, UUID, TutorAskRequest, TutorAskResponse

### Community 358 - "@testing-library/jest-dom"
Cohesion: 0.67
Nodes (3): Time, SchoolQualityResponse, SchoolQualityScore

### Community 367 - "curriculum handler.Upload — fixed wrong context key + double body-read bugs"
Cohesion: 0.50
Nodes (3): Time, CreateNotificationRequest, NotificationResponse
...
### Community 377 - "main"
Cohesion: 0.19
Nodes (9): generateSecret(), main(), main(), main(), HashPassword(), Pool, NewPool(), seededUser (+1 more)

### Community 379 - "PostgresStorage"
Cohesion: 0.31
Nodes (6): Context, Pool, ReadCloser, Reader, NewPostgresStorage(), PostgresStorage

### Community 382 - "(:Topic) Neo4j node label"
Cohesion: 0.60
Nodes (3): Context, Service, SubjectVersion

### Community 383 - "NewDriver"
Cohesion: 0.60
Nodes (4): DriverWithContext, main(), runMigrations(), splitStatements()

### Community 385 - "Run"
Cohesion: 0.20
Nodes (8): brpop_job(), close_redis(), get_redis(), Redis access for the AI service.  The Go backend pushes a plain job id string, Block for up to `timeout` seconds waiting for a job id on `queue`.     Returns, Consumes study-plan generation jobs off Redis (Capability 3B).  Same BRPOP loop, run_forever(), Redis

### Community 389 - "service.py"
Cohesion: 0.29
Nodes (9): _aggregate_topics(), _pack_days(), _plan_summary(), process_study_plan_job(), Capability 3B: The Study Plan Generator ("Personal Tutor").  Input is the rich, Collapse gap records into per-topic study entries. A topic can appear     as a, Kahn's algorithm over prerequisite edges among the study topics.     Ready set, Greedy day packing at HOURS_PER_DAY: small topics share a day, a     big topic (+1 more)

### Community 390 - "neo4j.py"
Cohesion: 0.36
Nodes (7): fetch_prerequisite_chain(), fetch_prerequisite_edges_among(), get_driver(), Neo4j access for the AI service (Capability 3A: root-cause traversal).  The Go, Walk backwards up the prerequisite graph from a symptom topic:     every (:Topi, All direct HAS_PREREQUISITE edges whose BOTH endpoints are in     topic_ids --, AsyncDriver

### Community 391 - "service.py"
Cohesion: 0.05
Nodes (51): ask_tutor(), AskRequest, BaseModel, POST /api/v1/tutor/ask (Capability 3C) -- called by the Go API's tutor proxy (in, _build_prompt(), match_clo_llm(), LLM-backed CLO matcher (Capability 2A) -- an optional upgrade over clo_matcher., clos: list of (code, description_en). Returns (best_code, confidence)     or (N (+43 more)

### Community 392 - "answer_key_worker.py"
Cohesion: 0.29
Nodes (4): process_answer_key_job(), Processes a separately-uploaded answer-key document (Capability 2C).  Real "Extr, Consumes answer-key upload jobs off Redis (Capability 2C).  Mirrors curriculum_w, run_forever()

### Community 393 - "exam_worker.py"
Cohesion: 0.29
Nodes (4): process_exam_job(), Orchestrates one exam-parsing job end to end (Capability 2A):    1. Fetch the, Consumes exam-upload jobs off Redis and parses them (Capability 2A).  Mirrors cu, run_forever()

### Community 394 - "main"
Cohesion: 0.43
Nodes (6): graphErrSuffix(), main(), ingestFile, ingestJob, prereqEdge, ParsedUnit

### Community 397 - "versions.go"
Cohesion: 0.50
Nodes (3): Time, SubjectVersion, SupersedeRequest

### Community 398 - ".ListTopicsBySubject"
Cohesion: 0.50
Nodes (3): Context, Repository, TopicListItem

### Community 399 - ".ListTopicsBySubject"
Cohesion: 0.50
Nodes (3): Context, Service, TopicListItem

### Community 409 - ".PresignDownload"
Cohesion: 0.29
Nodes (7): Context, Repository, Service, New(), PresignDownloadRequest, PresignResponse, PresignUploadRequest

### Community 410 - ".UploadAnswerKey"
Cohesion: 0.33
...
## Knowledge Gaps
- **610 isolated node(s):** `users`, `students`, `teachers`, `notifications`, `sync_logs` (+605 more)
...
- **Why does `Internal()` connect `DB Migration V013: create local storage` to `Authresponse`, `Architecture Doc: (root)`, `Notification Dto`, `Auth Repository`, `Career Repository`, `Pkg Crypto Crypto`, `.PresignDownload`, `Sync Dto`, `.UploadAnswerKey`, `Region Handler`, `School Handler`, `Cmd Api Main`, `Storage Dto`, `Impl Plan Doc: (root)`, `Ministry Dto`, `Frontend: NPM Dependencies`, `redis.py`, `Ministry Handler`, `Service`, `Service`, `autoprefixer`, `ag-grid-community`, `.AskTutor`, `logger.go`, `Run`, `Services Tutor Service`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Client` connect `Ai Careermatchrequest` to `Auth Repository`, `Career Repository`, `Agent Cmd Main`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `WriteError()` connect `Region Handler` to `School Handler`, `Student Handler`, `dto.go`, `Teacher Handler`, `Career Handler`, `Jobs Handler`, `DB Migration V013: create local storage`, `Storage Handler`, `DB Design Doc: Node Labels And Properties`, `Student Repository`, `Auth Handler`, `Ministry Handler`?**
